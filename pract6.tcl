...
set val(x) 1500;#add manually
set val(y) 1500;#add manually
set val(ifqlen) 1000;#add manually
set val(adhocRouting) AODV;#add manually
set val(nn) $tnn
set val(stop) 10.0
#add manually
...
Mac/802_11 set cdma_code_init_start_ 64;# cdma code for initialrequest (start)
Mac/802_11 set cdma_code_init_stop_ 127;# cdma code for initialrequest (stop)
Mac/802_11 set cdma_code_cqich_start_ 128 ;# cdma code for cqichrequest (start)
Mac/802_11 set cdma_code_cqich_stop_ 195;# cdma code for cqichrequest (stop)
Mac/802_11 set cdma_code_handover_start_ 196 ;# cdma code for handover request (start)
Mac/802_11 set cdma_code_handover_stop_ 255;# cdma code forhandover request (stop)
#end
...
proc stop {} {
	...
	800x400 &
	exec xgraph delay02.tr -geometry -x TIME -y delay -t End-to-End-Delay
	800x400 &
	$ns_ flush-trace
}
